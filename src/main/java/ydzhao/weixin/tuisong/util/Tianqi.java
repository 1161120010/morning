 ...
 */
public class Tianqi {
    private static String ak = "H7kaMpTu2BQ6AUVMpPkaZbdXRfdFQ2c1";
    private static String district_id = "120104";
    private static String sn = "dOaOeiTZNdU6fZMvSXQHGUVFKAZLbVDl";
